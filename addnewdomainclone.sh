...
eval $(echo "cd /home/www/$(cat /deletedomainbaru)/wp-content/themes/$(cat /deletenametheme)")
chmod 777 *
eval $(echo "cd /home/www/$(cat /deletedomain)")
